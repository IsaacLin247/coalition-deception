...
This is a dated post-audit analysis specification, written before production
replication outcomes are available. It is not a prospective preregistration of
the original study. The frozen `submission_protocol.json` specifies jobs, seeds,
...
- **ablation:** For each of the three removal conditions, removal minus default:
  ...
  both round settings. Hidden-partner is the repaired partner-information
  intervention described in `audit/pre_submission_information.md`.
