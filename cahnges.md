...
The production pipeline launched at **19:33:17 UTC on 11 September 2026**, after the protocol and code were pushed publicly. The desktop smoke pipeline passed all eight engineering jobs and all 302 test cells; the final supplementary unit suite has 96 passing tests. [RUN_STATUS.md](validation/RUN_STATUS.md) records the launch, public protocol identity, desktop environment, and automatic collection workflow. The scientific follow-up is still running.
